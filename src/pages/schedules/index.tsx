...
import { Plus, Clock, Play, Pencil, Trash2, Calendar, Activity } from 'lucide-react';
...
export function Schedules() {
  ...
  const { testCases, fetchTestCases } = useTestStore();
  ...
  const resetForm = () => {
    setEditingId(null);
    setFormData({ name: '', testCaseId: '', cronExpr: '0 0 * * *' });
  };
        ...
        <Sheet open={isOpen} onOpenChange={(open) => {
          ...
          <SheetContent className="w-[400px] sm:w-[450px] flex flex-col border-border/40">
            ...
            <div className="flex-1 py-6 space-y-6">
              ...
              <div className="space-y-2">
                <Label className="text-base font-semibold">选择测试用例</Label>
                <select 
            ...
            <SheetFooter className="mt-auto pt-6 border-t border-border/40 pb-2">
              <div className="flex w-full justify-end gap-3">
                ...
                <Button onClick={handleSave} disabled={!formData.name || !formData.testCaseId || isSaving}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-1 gap-x-4 mt-2 text-sm text-muted-foreground">
                      ...
                      <div className="flex items-center gap-2 sm:col-span-2">
                        ...
                        <span className="truncate">对应任务: {testCases.find(tc => tc.id === s.testCaseId)?.name || '未知用例'}</span>
                      </div>
                    </div>
                  </div>
