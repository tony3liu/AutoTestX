...
const GATEWAY_WS_DIAG_FLAG = 'autotestx:gateway-ws-diagnostic';
...
function shouldLogApiRequests(): boolean {
  try {
    return import.meta.env.DEV || window.localStorage.getItem('autotestx:api-log') === '1';
  } catch {
